...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            (b'\xff\x01pybites\x00\x01"\x99\xaa\xbbformat\x00\x00\x00\x00' b"\x00\x00"),
            CUSTOM_MAGIC_TABLE2,
            "Fantasy pybites file format",
        ),
        (
            "pybites_format_variant_2",
            (b'\xff\x01pybites\x01\x00"\x99\xcc\xddformat\x00\x00\x00\x00' b"\x00\x00"),
            CUSTOM_MAGIC_TABLE2,
            "Fantasy pybites file format",
        ),
        (
            "pybites_format_variant_3",
            (b'\xee\x01pybites\x00\x01"\x00\xec\xedformat\x01\x00\x00\x00' b"\x00\x01"),
            CUSTOM_MAGIC_TABLE2,
            "Fantasy pybites file format",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            (b'\xee\x01pyb1tes\x00\x01"\x99\xec\xedf0rm4t\x01\x00\x00\x00' b"\x00\x01"),
            CUSTOM_MAGIC_TABLE2,
        ),
    ],
)
